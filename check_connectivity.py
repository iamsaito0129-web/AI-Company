...
from puzzle_solver_final import ADJ, WALLS, START, GOAL, YELLOWS, Y_BIT, fm

segments = []
mandatory = set([START, GOAL])
for y in YELLOWS: mandatory.add(y)
...
print(f"Nodes unreachable: {lost}")
if not lost:
    print("ALL CONNECTED!")
